...
export const TENANT_EXPORT_COLUMNS = [
  { header: "No", key: "no", width: 8, pdfWidth: 8, pdfHalign: "center" },
  { header: "Nama Penyewa", key: "tenant_name", width: 26, pdfWidth: 24 },
  { header: "Tanggal Pembayaran", key: "payment_date", width: 18, pdfWidth: 17 },
  { header: "Status", key: "keterangan", width: 18, pdfWidth: 18 },
  { header: "Ruangan", key: "room_number", width: 14, pdfWidth: 13 },
  { header: "Masa Berlaku", key: "masa_berlaku", width: 24, pdfWidth: 22 },
  { header: "Ukuran", key: "ukuran_m2", width: 16, pdfWidth: 13 },
  { header: "Harga Sewa", key: "harga_m2", type: "currency", pdfWidth: 17 },
  { header: "Kontrak Murni", key: "kontrak", type: "currency", pdfWidth: 18 },
  { header: "JTU", key: "jtu", type: "currency", pdfWidth: 14 },
  {
    header: "Kontrak + JTU",
