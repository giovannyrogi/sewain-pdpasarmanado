...
const TerminationApprovalModal = ({
  open,
  onClose,
  selectedData,
  loading,
  ...
  const getDataApprovals = async () => {
    setLoadingMessage("Memperbarui data Termination Approval...");
    loadingTrue();
    try {
    ...
    >
      <Fade in={open}>
        <Box sx={style}>
          ...
          <Grid container direction="column" spacing={2}>
            {approvalList &&
              approvalList.map((item, index) => (
                <Grid size={12} key={item.approval_id}>
                  <Box
                    display="flex"
                    alignItems="center"
                    gap={2}
          ...
          {/* {selectedData &&
            selectedData.termination_approval_status === "canceled" && (
              <Grid
                size={12}
                container
                spacing={1}
              ...
              >
                <Grid size={12}>
                  ...
                  >
                    ...
                    >
                      {selectedData.cancelled_user_name}
                    </span>
                  </Typography>
                  <Typography
                    sx={{
                  ...
                  >
                    ...
                    >
                      {moment(selectedData.cancelled_at).format(
                        "DD/MM/YYYY HH:mm"
                      )}
                    </span>
                  </Typography>
...
export default TerminationApprovalModal;
